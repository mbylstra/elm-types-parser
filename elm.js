	...
	if (_p0.ctor === 'Just') {
		...
		return _elm_lang$core$Native_Utils.crashCase(
			'Helpers',
			{
				...
				end: {line: 97, column: 40}
			},
			_p0)('List is empty');
	}
};
var _user$project$Helpers$unsafeAssumeSuccess = function (result) {
	var _p2 = result;
	if (_p2.ctor === 'Ok') {
		return _p2._0;
	} else {
...
var _user$project$Helpers$unsafeDictGet = F3(
	function (errorMessage, key, dict) {
			...
			return _elm_lang$core$Native_Utils.crashCase(
				...
				A2(
					...
					A2(
						...
						A2(_elm_lang$core$Basics_ops['++'], ' in ', errorMessage))));
		}
	});
...
var _user$project$Helpers$allTrue = _elm_lang$core$List$all(_elm_lang$core$Basics$identity);
...
var _user$project$Helpers$qualifiedNameToPath = function (name) {
	return A2(
		...
		A2(
			...
			function (_p10) {
				var _p11 = _p10;
				var fileName = A2(_elm_lang$core$Basics_ops['++'], _p11._0, '.elm');
				var fullReversePath = {ctor: '::', _0: fileName, _1: _p11._1};
...
var _user$project$Types$QualifiedName = F2(
	function (a, b) {
		return {dottedModulePath: a, name: b};
	});
var _user$project$Types$UnionR = F3(
	function (a, b, c) {
		return {name: a, typeVars: b, definition: c};
	});
var _user$project$Types$QualifiedUnionR = F3(
	function (a, b, c) {
		return {name: a, typeVars: b, definition: c};
	});
var _user$project$Types$TypeAliasDefinitionR = F3(
	function (a, b, c) {
		return {name: a, typeVars: b, definition: c};
	});
...
var _user$project$Types$ModuleInfo = F5(
	function (a, b, c, d, e) {
		return {dottedModulePath: a, viewFunctions: b, localTypeAliases: c, localUnionTypes: d, externalNamesModuleInfo: e};
	});
var _user$project$Types$QualifiedModuleInfo = F4(
	function (a, b, c, d) {
		return {dottedModulePath: a, viewFunctions: b, typeAliases: c, unionTypes: d};
	});
var _user$project$Types$AllTypes = F2(
	function (a, b) {
		return {subjectModuleInfo: a, allModulesInfo: b};
	});
var _user$project$Types$QualifiedAllTypes = F2(
	function (a, b) {
		return {subjectModuleInfo: a, allModulesInfo: b};
	});
...
var _user$project$Types$TypeAliasDefinition = function (a) {
	return {ctor: 'TypeAliasDefinition', _0: a};
};
var _user$project$Types$Module = function (a) {
	return {ctor: 'Module', _0: a};
};
var _user$project$Types$Record = F2(
	function (a, b) {
		return {ctor: 'Record', _0: a, _1: b};
	});
var _user$project$Types$Type = F2(
	function (a, b) {
		return {ctor: 'Type', _0: a, _1: b};
	});
var _user$project$Types$Tuple = function (a) {
	return {ctor: 'Tuple', _0: a};
};
var _user$project$Types$Lambda = F2(
	function (a, b) {
...
var _user$project$Types$QualifiedRecord = F2(
	function (a, b) {
		return {ctor: 'QualifiedRecord', _0: a, _1: b};
	});
var _user$project$Types$QualifiedType = F2(
	function (a, b) {
		return {ctor: 'QualifiedType', _0: a, _1: b};
	});
var _user$project$Types$QualifiedTuple = function (a) {
	return {ctor: 'QualifiedTuple', _0: a};
};
var _user$project$Types$QualifiedLambda = F2(
	function (a, b) {
		return {ctor: 'QualifiedLambda', _0: a, _1: b};
	});
var _user$project$Types$QualifiedVar = function (a) {
	return {ctor: 'QualifiedVar', _0: a};
};
...
var _user$project$ElmTypesParser$isSpace = function ($char) {
	return _elm_lang$core$Native_Utils.eq(
		$char,
		_elm_lang$core$Native_Utils.chr(' ')) || (_elm_lang$core$Native_Utils.eq(
		$char,
...
var _user$project$ElmTypesParser$whitespace = A2(_elm_tools$parser$Parser$ignore, _elm_tools$parser$Parser$zeroOrMore, _user$project$ElmTypesParser$isSpace);
var _user$project$ElmTypesParser$spaces = _user$project$ElmTypesParser$whitespace;
var _user$project$ElmTypesParser$commaAnd = function (parser) {
	return A2(
		_elm_tools$parser$Parser$delayedCommit,
		_user$project$ElmTypesParser$spaces,
		A2(
			_elm_tools$parser$Parser_ops['|='],
			A2(
				_elm_tools$parser$Parser_ops['|.'],
				A2(
					...
					_user$project$ElmTypesParser$comma),
				_user$project$ElmTypesParser$spaces),
			parser));
};
var _user$project$ElmTypesParser$commaSepHelp = F2(
		...
		return _elm_tools$parser$Parser$oneOf(
			{
				...
				_0: A2(
					...
					function (a) {
						return A2(
							_user$project$ElmTypesParser$commaSepHelp,
							parser,
							{ctor: '::', _0: a, _1: revList});
					},
					_user$project$ElmTypesParser$commaAnd(parser)),
				_1: {
					ctor: '::',
					_0: _elm_tools$parser$Parser$succeed(
						_elm_lang$core$List$reverse(revList)),
...
var _user$project$ElmTypesParser$commaSep = function (parser) {
	return A2(
		_elm_tools$parser$Parser$andThen,
		function (first) {
			return A2(
...
var _user$project$ElmTypesParser$someWhitespace = A2(
	_elm_tools$parser$Parser$ignore,
	_elm_tools$parser$Parser$AtLeast(1),
	_user$project$ElmTypesParser$isSpace);
var _user$project$ElmTypesParser$isInnerVarChar = function ($char) {
...
var _user$project$ElmTypesParser$variable = function (isFirst) {
	return A3(_elm_tools$parser$Parser_LanguageKit$variable, isFirst, _user$project$ElmTypesParser$isInnerVarChar, _elm_lang$core$Set$empty);
};
var _user$project$ElmTypesParser$capVar = _user$project$ElmTypesParser$variable(_elm_lang$core$Char$isUpper);
var _user$project$ElmTypesParser$qualifiedCapVar = _elm_tools$parser$Parser$source(
	A2(
		_elm_tools$parser$Parser_ops['|.'],
		_user$project$ElmTypesParser$capVar,
		A2(
			...
			A2(
				...
				_user$project$ElmTypesParser$capVar))));
var _user$project$ElmTypesParser$lowVar = _user$project$ElmTypesParser$variable(_elm_lang$core$Char$isLower);
var _user$project$ElmTypesParser$parseTypeVariables = A2(
	_elm_tools$parser$Parser$repeat,
	_elm_tools$parser$Parser$zeroOrMore,
	A3(
		_elm_tools$parser$Parser$delayedCommitMap,
		F2(
			function (typeVar, _p0) {
				return typeVar;
			}),
		_user$project$ElmTypesParser$lowVar,
		_user$project$ElmTypesParser$someWhitespace));
var _user$project$ElmTypesParser$tuplize = function (args) {
	var _p1 = args;
	if ((_p1.ctor === '::') && (_p1._1.ctor === '[]')) {
		return _p1._0;
	} else {
		return _user$project$Types$Tuple(args);
	}
};
var _user$project$ElmTypesParser$ext = A2(
	_elm_tools$parser$Parser_ops['|.'],
	A2(
		_elm_tools$parser$Parser_ops['|.'],
		A2(
		...
		_elm_tools$parser$Parser$symbol('|')),
	_user$project$ElmTypesParser$spaces);
var _user$project$ElmTypesParser$extension = _elm_tools$parser$Parser$oneOf(
	{
		ctor: '::',
		_0: A3(
			_elm_tools$parser$Parser$delayedCommitMap,
			_elm_lang$core$Basics$always,
			_user$project$ElmTypesParser$ext,
			_elm_tools$parser$Parser$succeed(
				{ctor: '_Tuple0'})),
		_1: {
			ctor: '::',
...
var _user$project$ElmTypesParser$arrow = _elm_tools$parser$Parser$symbol('->');
var _user$project$ElmTypesParser$tipe = _elm_tools$parser$Parser$lazy(
	function (_p2) {
		return A2(_elm_tools$parser$Parser$andThen, _user$project$ElmTypesParser$tipeHelp, _user$project$ElmTypesParser$tipeTerm);
	});
var _user$project$ElmTypesParser$tipeHelp = function (t) {
	return _elm_tools$parser$Parser$oneOf(
		{
			ctor: '::',
			_0: A2(
				_elm_tools$parser$Parser$map,
				_user$project$Types$Lambda(t),
				_user$project$ElmTypesParser$arrowAndType),
			_1: {
				ctor: '::',
...
var _user$project$ElmTypesParser$arrowAndType = A2(
	_elm_tools$parser$Parser$delayedCommit,
	_user$project$ElmTypesParser$spaces,
	A2(
		_elm_tools$parser$Parser_ops['|='],
		A2(
			...
			A2(
				_elm_tools$parser$Parser_ops['|.'],
				_elm_tools$parser$Parser$succeed(_elm_lang$core$Basics$identity),
				_user$project$ElmTypesParser$arrow),
			_user$project$ElmTypesParser$spaces),
		_user$project$ElmTypesParser$tipe));
var _user$project$ElmTypesParser$tipeTerm = _elm_tools$parser$Parser$lazy(
	function (_p3) {
		return _elm_tools$parser$Parser$oneOf(
			{
				ctor: '::',
				_0: A2(_elm_tools$parser$Parser$map, _user$project$Types$Var, _user$project$ElmTypesParser$lowVar),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_tools$parser$Parser_ops['|='],
						A2(
							_elm_tools$parser$Parser_ops['|='],
							_elm_tools$parser$Parser$succeed(_user$project$Types$Type),
							_user$project$ElmTypesParser$qualifiedCapVar),
						_user$project$ElmTypesParser$chompArgs(
							{ctor: '[]'})),
					_1: {
						ctor: '::',
						_0: _user$project$ElmTypesParser$record,
						_1: {
							ctor: '::',
							_0: _user$project$ElmTypesParser$tuple,
							_1: {ctor: '[]'}
						}
					}
				}
...
var _user$project$ElmTypesParser$chompArgs = function (revArgs) {
	return _elm_tools$parser$Parser$oneOf(
		{
			ctor: '::',
			_0: A2(
				_elm_tools$parser$Parser$andThen,
				function (arg) {
					return _user$project$ElmTypesParser$chompArgs(
						{ctor: '::', _0: arg, _1: revArgs});
				},
				A2(_elm_tools$parser$Parser$delayedCommit, _user$project$ElmTypesParser$spaces, _user$project$ElmTypesParser$term)),
			_1: {
				ctor: '::',
				_0: _elm_tools$parser$Parser$succeed(
...
var _user$project$ElmTypesParser$term = _elm_tools$parser$Parser$lazy(
	function (_p4) {
		return _elm_tools$parser$Parser$oneOf(
			{
				ctor: '::',
...
var _user$project$ElmTypesParser$record = _elm_tools$parser$Parser$lazy(
	function (_p5) {
		return A2(
			_elm_tools$parser$Parser_ops['|.'],
			A2(
					...
					A2(
						...
						A2(
							...
							A2(
								_elm_tools$parser$Parser_ops['|.'],
								_elm_tools$parser$Parser$succeed(
									_elm_lang$core$Basics$flip(_user$project$Types$Record)),
								_elm_tools$parser$Parser$symbol('{')),
							_user$project$ElmTypesParser$spaces),
						_user$project$ElmTypesParser$extension),
					_user$project$ElmTypesParser$commaSep(_user$project$ElmTypesParser$field)),
				_user$project$ElmTypesParser$spaces),
			_elm_tools$parser$Parser$symbol('}'));
	});
var _user$project$ElmTypesParser$field = _elm_tools$parser$Parser$lazy(
	function (_p6) {
		return A2(
			_elm_tools$parser$Parser_ops['|='],
			A2(
...
var _user$project$ElmTypesParser$tuple = A2(
	_elm_tools$parser$Parser$map,
	_user$project$ElmTypesParser$tuplize,
	A2(_elm_tools$parser$Parser_LanguageKit$tuple, _user$project$ElmTypesParser$spaces, _user$project$ElmTypesParser$tipe));
var _user$project$ElmTypesParser$typeConstructorArg = _elm_tools$parser$Parser$oneOf(
	{
		ctor: '::',
		_0: _user$project$ElmTypesParser$record,
		_1: {
...
var _user$project$ElmTypesParser$typeConstructorArgsExtraOne = A2(
	_elm_tools$parser$Parser$delayedCommit,
	_user$project$ElmTypesParser$someWhitespace,
	A2(
		_elm_tools$parser$Parser_ops['|='],
		_elm_tools$parser$Parser$succeed(_elm_lang$core$Basics$identity),
		_user$project$ElmTypesParser$typeConstructorArg));
var _user$project$ElmTypesParser$typeConstructorArgsHelp = function (revList) {
	return _elm_tools$parser$Parser$oneOf(
		{
			ctor: '::',
			_0: A2(
				_elm_tools$parser$Parser$andThen,
				function (extraOne) {
					return _user$project$ElmTypesParser$typeConstructorArgsHelp(
						{ctor: '::', _0: extraOne, _1: revList});
				},
				_user$project$ElmTypesParser$typeConstructorArgsExtraOne),
			_1: {
				ctor: '::',
				_0: _elm_tools$parser$Parser$succeed(
					_elm_lang$core$List$reverse(revList)),
...
var _user$project$ElmTypesParser$typeConstructorArgs = _elm_tools$parser$Parser$oneOf(
	{
		ctor: '::',
		_0: A2(
			_elm_tools$parser$Parser$andThen,
...
var _user$project$ElmTypesParser$typeConstructor = A2(
	_elm_tools$parser$Parser_ops['|='],
	A2(
		_elm_tools$parser$Parser_ops['|='],
		_elm_tools$parser$Parser$succeed(
		...
		_user$project$ElmTypesParser$capVar),
	_user$project$ElmTypesParser$typeConstructorArgs);
var _user$project$ElmTypesParser$typeConstructorsExtraOne = A2(
	_elm_tools$parser$Parser$delayedCommit,
	_user$project$ElmTypesParser$someWhitespace,
	A2(
		_elm_tools$parser$Parser_ops['|='],
		A2(
			...
			A2(
				_elm_tools$parser$Parser_ops['|.'],
				_elm_tools$parser$Parser$succeed(_elm_lang$core$Basics$identity),
				_user$project$ElmTypesParser$pipeSymbol),
			_user$project$ElmTypesParser$someWhitespace),
		_user$project$ElmTypesParser$typeConstructor));
var _user$project$ElmTypesParser$typeConstructorsHelp = function (revList) {
	return _elm_tools$parser$Parser$oneOf(
		{
			ctor: '::',
			_0: A2(
				_elm_tools$parser$Parser$andThen,
				function (extraOne) {
					return _user$project$ElmTypesParser$typeConstructorsHelp(
						{ctor: '::', _0: extraOne, _1: revList});
				},
				_user$project$ElmTypesParser$typeConstructorsExtraOne),
			_1: {
				ctor: '::',
				_0: _elm_tools$parser$Parser$succeed(
					_elm_lang$core$List$reverse(revList)),
...
var _user$project$ElmTypesParser$typeConstructors = A2(
	_elm_tools$parser$Parser$andThen,
	function (first) {
		return _user$project$ElmTypesParser$typeConstructorsHelp(
			{
	...
	_user$project$ElmTypesParser$typeConstructor);
var _user$project$ElmTypesParser$unionType = A2(
	_elm_tools$parser$Parser_ops['|='],
	A2(
		_elm_tools$parser$Parser_ops['|.'],
		A2(
				...
				A2(
					...
					A2(
						...
						A2(
							...
							A2(
								_elm_tools$parser$Parser_ops['|.'],
								_elm_tools$parser$Parser$succeed(_user$project$Types$UnionR),
								_elm_tools$parser$Parser$symbol('type')),
							_user$project$ElmTypesParser$someWhitespace),
						_user$project$ElmTypesParser$capVar),
					_user$project$ElmTypesParser$someWhitespace),
				_user$project$ElmTypesParser$parseTypeVariables),
			_elm_tools$parser$Parser$symbol('=')),
		_user$project$ElmTypesParser$someWhitespace),
	_user$project$ElmTypesParser$typeConstructors);
var _user$project$ElmTypesParser$parseUnion = function (source) {
	return A2(_elm_tools$parser$Parser$run, _user$project$ElmTypesParser$unionType, source);
};
var _user$project$ElmTypesParser$parseTypeConstructors = function (source) {
	return A2(_elm_tools$parser$Parser$run, _user$project$ElmTypesParser$typeConstructors, source);
};
var _user$project$ElmTypesParser$parseTypeConstructor = function (source) {
	return A2(_elm_tools$parser$Parser$run, _user$project$ElmTypesParser$typeConstructor, source);
};
var _user$project$ElmTypesParser$typeAlias = A2(
	_elm_tools$parser$Parser_ops['|='],
	A2(
		_elm_tools$parser$Parser_ops['|.'],
		A2(
				...
				A2(
					...
					A2(
						...
						A2(
							...
							A2(
								_elm_tools$parser$Parser_ops['|.'],
								_elm_tools$parser$Parser$succeed(_user$project$Types$TypeAliasDefinitionR),
								_elm_tools$parser$Parser$symbol('type alias')),
							_user$project$ElmTypesParser$someWhitespace),
						_user$project$ElmTypesParser$capVar),
					_user$project$ElmTypesParser$someWhitespace),
				_user$project$ElmTypesParser$parseTypeVariables),
		...
		_user$project$ElmTypesParser$someWhitespace),
	_user$project$ElmTypesParser$tipe);
var _user$project$ElmTypesParser$parseTypeAlias = function (source) {
	return A2(_elm_tools$parser$Parser$run, _user$project$ElmTypesParser$typeAlias, source);
};
var _user$project$ElmTypesParser$typeAnnotation = A2(
	_elm_tools$parser$Parser_ops['|='],
	A2(
		_elm_tools$parser$Parser_ops['|.'],
		A2(
		...
		_user$project$ElmTypesParser$someWhitespace),
	_user$project$ElmTypesParser$tipe);
var _user$project$ElmTypesParser$parseTypeAnnotation = function (string) {
	return A2(_elm_tools$parser$Parser$run, _user$project$ElmTypesParser$typeAnnotation, string);
};
var _user$project$ElmTypesParser$parseTipe = function (source) {
...
var _user$project$ImportStatement$closedListing = A2(
	...
	{ctor: '[]'},
	false);
var _user$project$ImportStatement$elmImplicitImports = {
	ctor: '::',
	_0: A3(
		_user$project$Types$ImportStatement,
		'Basics',
		_elm_lang$core$Maybe$Nothing,
		A2(
			_user$project$Types$Listing,
	...
	_1: {
		ctor: '::',
		_0: A3(_user$project$Types$ImportStatement, 'Debug', _elm_lang$core$Maybe$Nothing, _user$project$ImportStatement$closedListing),
		_1: {
			ctor: '::',
			_0: A3(
				_user$project$Types$ImportStatement,
			...
			_1: {
				...
				_1: {
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: A3(_user$project$Types$ImportStatement, 'Tuple', _elm_lang$core$Maybe$Nothing, _user$project$ImportStatement$closedListing),
							_1: {
								ctor: '::',
								_0: A3(
									_user$project$Types$ImportStatement,
...
var _user$project$ImportStatement$openListing = A2(
	...
	{ctor: '[]'},
	true);
var _user$project$ImportStatement$lowOrCapVar = _elm_tools$parser$Parser$oneOf(
	{
		ctor: '::',
		_0: _user$project$ElmTypesParser$lowVar,
		_1: {
			ctor: '::',
			_0: _user$project$ElmTypesParser$capVar,
			_1: {ctor: '[]'}
		}
	});
var _user$project$ImportStatement$unionTypeWithAllConstructors = A3(
	_elm_tools$parser$Parser$delayedCommitMap,
	F2(
		function (name, _p6) {
			return name;
	...
	_user$project$ElmTypesParser$capVar,
	_elm_tools$parser$Parser$symbol('(..)'));
var _user$project$ImportStatement$exposedType = _elm_tools$parser$Parser$oneOf(
	{
		ctor: '::',
		_0: _user$project$ImportStatement$unionTypeWithAllConstructors,
		_1: {
			ctor: '::',
			_0: _user$project$ElmTypesParser$lowVar,
			_1: {
	...
	A2(
		...
		A2(
			...
			A2(
				...
				_user$project$ImportStatement$exposedType),
			_user$project$ElmTypesParser$whitespace),
		A2(
			_elm_tools$parser$Parser$repeat,
			_elm_tools$parser$Parser$zeroOrMore,
...
var _user$project$ImportStatement$importAlias = function () {
	var noAlias = _elm_tools$parser$Parser$succeed(_elm_lang$core$Maybe$Nothing);
	var hasAlias = A2(
		_elm_tools$parser$Parser$delayedCommit,
		_user$project$ElmTypesParser$someWhitespace,
		A2(
			...
			A2(
				...
				A2(
					...
					_elm_tools$parser$Parser$symbol('as')),
				_user$project$ElmTypesParser$someWhitespace),
			_user$project$ElmTypesParser$qualifiedCapVar));
	return _elm_tools$parser$Parser$oneOf(
		{
...
var _user$project$ModuleInfo$getNamesInUnionDefinition = function (_p4) {
	var _p5 = _p4;
	return A2(
		_elm_lang$core$List$concatMap,
		function (_p6) {
			var _p7 = _p6;
			return A2(_elm_lang$core$List$concatMap, _user$project$ModuleInfo$getNames, _p7._1);
		},
		_p5.definition);
};
...
var _user$project$ModuleInfo$groupNamesByModule = function (externalNamesModuleInfo) {
	return A2(
		...
		function (_p8) {
			var _p9 = _p8;
			return {moduleName: _p9._0, relevantNames: _p9._1};
		},
		_elm_lang$core$Dict$toList(
			_user$project$Helpers$groupByFirstTupleItem(
				A2(
					_elm_lang$core$List$map,
					function (_p10) {
						var _p11 = _p10;
						return {ctor: '_Tuple2', _0: _p11.dottedModulePath, _1: _p11.name};
					},
		...
		function (block) {
			...
			switch (_p12.ctor) {
				case 'TypeAliasDefinition':
					return _elm_lang$core$Maybe$Just(_p12._0.name);
				case 'Union':
					return _elm_lang$core$Maybe$Just(_p12._0.name);
				default:
					return _elm_lang$core$Maybe$Nothing;
		...
		do {
			switch (_p13.ctor) {
				...
				case 'TypeAliasDefinition':
					return {
						ctor: '::',
						_0: _p13._0.definition,
						_1: {ctor: '[]'}
					};
				case 'Union':
					return A2(_elm_lang$core$List$concatMap, _elm_lang$core$Tuple$second, _p13._0.definition);
				default:
					break _v7_3;
			}
		} while(false);
		...
		A2(
			...
			function (block) {
				...
				if (_p15.ctor === 'Union') {
					var _p16 = _p15._0;
					return _elm_lang$core$Maybe$Just(
						{ctor: '_Tuple2', _0: _p16.name, _1: _p16});
				} else {
					return _elm_lang$core$Maybe$Nothing;
				}
			},
...
var _user$project$ModuleInfo$getTypeAliases = function (blocks) {
	return _elm_lang$core$Dict$fromList(
		A2(
			...
			function (block) {
				var _p17 = block;
				if (_p17.ctor === 'TypeAliasDefinition') {
					return _elm_lang$core$Maybe$Just(
						{ctor: '_Tuple2', _0: _p17._0.name, _1: _p17._0.definition});
				} else {
					return _elm_lang$core$Maybe$Nothing;
				}
			},
...
var _user$project$ModuleInfo$getDottedModulePath = function (blocks) {
	return _user$project$Helpers$unsafeListHead(
		A2(
			_elm_lang$core$List$filterMap,
			function (block) {
				var _p18 = block;
...
var _user$project$ModuleInfo$LocalTypeDefinitions = F2(
	function (a, b) {
		return {unionTypes: a, typeAliases: b};
	});
var _user$project$ModuleInfo$ExternalNamesAcc = F3(
	function (a, b, c) {
		return {namesToLookUp: a, doneLookingUp: b, externalNames: c};
	});
var _user$project$ModuleInfo$ExternalName = {ctor: 'ExternalName'};
var _user$project$ModuleInfo$LocalTypeAlias = function (a) {
	return {ctor: 'LocalTypeAlias', _0: a};
};
var _user$project$ModuleInfo$LocalUnionType = function (a) {
	return {ctor: 'LocalUnionType', _0: a};
};
var _user$project$ModuleInfo$getNameLocation = F2(
	function (_p19, name) {
		var _p20 = _p19;
		if (A2(_elm_lang$core$String$contains, '.', name)) {
			return _user$project$ModuleInfo$ExternalName;
		} else {
			var _p21 = A2(_elm_lang$core$Dict$get, name, _p20.unionTypes);
			if (_p21.ctor === 'Just') {
				return _user$project$ModuleInfo$LocalUnionType(_p21._0);
			} else {
				var _p22 = A2(_elm_lang$core$Dict$get, name, _p20.typeAliases);
				if (_p22.ctor === 'Just') {
					return _user$project$ModuleInfo$LocalTypeAlias(_p22._0);
				} else {
					return _user$project$ModuleInfo$ExternalName;
				}
			}
...
var _user$project$ModuleInfo$isExternalName = F2(
	function (localTypeDefinitions, name) {
		var _p23 = A2(_user$project$ModuleInfo$getNameLocation, localTypeDefinitions, name);
		switch (_p23.ctor) {
			case 'LocalUnionType':
				return false;
			case 'LocalTypeAlias':
...
var _user$project$ModuleInfo$getExternalNames_ = F2(
	function (localTypeDefinitions, acc) {
		getExternalNames_:
		while (true) {
			var _p24 = localTypeDefinitions;
			var unionTypes = _p24.unionTypes;
			var typeAliases = _p24.typeAliases;
			var _p25 = acc;
			var externalNames = _p25.externalNames;
			var namesToLookUp = _p25.namesToLookUp;
			var doneLookingUp = _p25.doneLookingUp;
			var _p26 = namesToLookUp;
			if (_p26.ctor === '[]') {
				return acc;
			} else {
				var _p29 = _p26._0;
				var _p28 = _p26._1;
				if (A2(_elm_lang$core$List$member, _p29, doneLookingUp)) {
					var _v17 = localTypeDefinitions,
						_v18 = _elm_lang$core$Native_Utils.update(
						acc,
						{namesToLookUp: _p28});
					localTypeDefinitions = _v17;
					acc = _v18;
					continue getExternalNames_;
				} else {
					var _p27 = A2(_user$project$ModuleInfo$getNameLocation, localTypeDefinitions, _p29);
					switch (_p27.ctor) {
						case 'ExternalName':
							var _v20 = localTypeDefinitions,
								_v21 = {
								externalNames: {ctor: '::', _0: _p29, _1: externalNames},
								doneLookingUp: {ctor: '::', _0: _p29, _1: doneLookingUp},
								namesToLookUp: _p28
							};
							localTypeDefinitions = _v20;
							acc = _v21;
							continue getExternalNames_;
						case 'LocalUnionType':
							var extraNames = _user$project$ModuleInfo$getNamesInUnionDefinition(_p27._0);
							var _v22 = localTypeDefinitions,
								_v23 = _elm_lang$core$Native_Utils.update(
								acc,
								{
									namesToLookUp: A2(_elm_lang$core$Basics_ops['++'], _p28, extraNames),
									doneLookingUp: {ctor: '::', _0: _p29, _1: doneLookingUp}
								});
							localTypeDefinitions = _v22;
							acc = _v23;
							continue getExternalNames_;
						default:
							var extraNames = _user$project$ModuleInfo$getNames(_p27._0);
							var _v24 = localTypeDefinitions,
...
var _user$project$ModuleInfo$getExternalNames = F2(
	function (localTypeDefinitions, names) {
		return A2(
			_elm_lang$core$List$filter,
			function (_p30) {
				return !_user$project$ModuleInfo$isCoreName(_p30);
			},
			function (_) {
				return _.externalNames;
			}(
				A2(
					_user$project$ModuleInfo$getExternalNames_,
...
var _user$project$ToQualified$qualifyExternalName = function (_p0) {
	var _p1 = _p0;
	var _p5 = _p1.name;
	var _p4 = _p1.externalNamesModuleInfo;
	if (A2(_elm_lang$core$List$member, _p5, _user$project$ModuleInfo$coreTypes)) {
		return {dottedModulePath: '__CORE__', name: _p5};
	} else {
		var _p2 = A2(_elm_lang$core$Dict$get, _p5, _p4);
		if (_p2.ctor === 'Just') {
			return _p2._0;
		} else {
			return _elm_lang$core$Native_Utils.crashCase(
...
var _user$project$ToQualified$qualifyLocalName = F2(
	function (dottedModulePath, name) {
		return {dottedModulePath: dottedModulePath, name: name};
	});
var _user$project$ToQualified$isExternalName = F2(
	function (subjectModuleInfo, name) {
		var _p6 = A2(_elm_lang$core$Dict$get, name, subjectModuleInfo.externalNamesModuleInfo);
		if (_p6.ctor === 'Just') {
			return true;
		} else {
			return false;
...
var _user$project$ToQualified$isLocalName = F2(
	function (subjectModuleInfo, name) {
		var _p7 = A2(_elm_lang$core$Dict$get, name, subjectModuleInfo.localUnionTypes);
		if (_p7.ctor === 'Just') {
			return true;
		} else {
			var _p8 = A2(_elm_lang$core$Dict$get, name, subjectModuleInfo.localTypeAliases);
			if (_p8.ctor === 'Just') {
				return true;
			} else {
				return false;
...
var _user$project$ToQualified$isNameToIgnore = F2(
	function (subjectModuleInfo, name) {
		return (!A2(_user$project$ToQualified$isLocalName, subjectModuleInfo, name)) && (!A2(_user$project$ToQualified$isExternalName, subjectModuleInfo, name));
	});
var _user$project$ToQualified$qualifyName = function (_p9) {
	var _p10 = _p9;
	var _p14 = _p10.name;
	var _p13 = _p10.moduleInfo;
	var _p11 = A2(_user$project$ToQualified$isLocalName, _p13, _p14);
	if (_p11 === true) {
		return A2(_user$project$Types$QualifiedName, _p13.dottedModulePath, _p14);
	} else {
		var _p12 = A2(_user$project$ToQualified$isExternalName, _p13, _p14);
		if (_p12 === true) {
			return _user$project$ToQualified$qualifyExternalName(
				{externalNamesModuleInfo: _p13.externalNamesModuleInfo, name: _p14, alreadyDone: _p10.alreadyDone});
		} else {
			return {dottedModulePath: 'IGNORED', name: _p14};
		}
	}
};
var _user$project$ToQualified$qualifyType = F2(
	function (_p15, tipe) {
		var _p16 = _p15;
		var _p20 = _p16;
		var _p17 = tipe;
		switch (_p17.ctor) {
			case 'Var':
				return _user$project$Types$QualifiedVar(_p17._0);
			case 'Lambda':
				return A2(
					_user$project$Types$QualifiedLambda,
					A2(_user$project$ToQualified$qualifyType, _p20, _p17._0),
					A2(_user$project$ToQualified$qualifyType, _p20, _p17._1));
			case 'Tuple':
				return _user$project$Types$QualifiedTuple(
					A2(
						_elm_lang$core$List$map,
						_user$project$ToQualified$qualifyType(_p20),
						_p17._0));
			case 'Type':
				return A2(
					_user$project$Types$QualifiedType,
					_user$project$ToQualified$qualifyName(
						{moduleInfo: _p16.moduleInfo, name: _p17._0, alreadyDone: _p16.alreadyDone}),
					A2(
						_elm_lang$core$List$map,
						_user$project$ToQualified$qualifyType(_p20),
						_p17._1));
			default:
				var qualifiedFields = A2(
					_elm_lang$core$List$map,
					function (_p18) {
						var _p19 = _p18;
						return {
							ctor: '_Tuple2',
							_0: _p19._0,
							_1: A2(_user$project$ToQualified$qualifyType, _p20, _p19._1)
						};
					},
					_p17._0);
				return A2(_user$project$Types$QualifiedRecord, qualifiedFields, _p17._1);
		}
	});
var _user$project$ToQualified$qualifyTypeConstructor = F2(
	function (_p22, _p21) {
		var _p23 = _p22;
		var _p24 = _p21;
		return {
			...
			_1: A2(
				_elm_lang$core$List$map,
				_user$project$ToQualified$qualifyType(
					{moduleInfo: _p23.moduleInfo, alreadyDone: _p23.alreadyDone}),
				_p24._1)
		};
	});
var _user$project$ToQualified$qualifyUnionDefinition = F2(
	function (_p25, typeConstructors) {
		var _p26 = _p25;
		return A2(
			_elm_lang$core$List$map,
			_user$project$ToQualified$qualifyTypeConstructor(
				{moduleInfo: _p26.moduleInfo, alreadyDone: _p26.alreadyDone}),
			typeConstructors);
	});
var _user$project$ToQualified$qualifyUnionR = F2(
	function (_p28, _p27) {
		var _p29 = _p28;
		var _p30 = _p27;
		return {
			name: _p30.name,
			typeVars: _p30.typeVars,
			definition: A2(
				_user$project$ToQualified$qualifyUnionDefinition,
				{moduleInfo: _p29.moduleInfo, alreadyDone: _p29.alreadyDone},
				_p30.definition)
		};
	});
var _user$project$ToQualified$toQualifiedModuleInfo = function (moduleInfo) {
	var initContext = {
		moduleInfo: moduleInfo,
		alreadyDone: {ctor: '[]'}
	};
	var _p31 = moduleInfo;
	var viewFunctions = _p31.viewFunctions;
	var localTypeAliases = _p31.localTypeAliases;
	var localUnionTypes = _p31.localUnionTypes;
	var externalNamesModuleInfo = _p31.externalNamesModuleInfo;
	var qualifiedViewFunctions = A2(
		_elm_lang$core$Dict$map,
		F2(
			function (name, tipe) {
				return A2(_user$project$ToQualified$qualifyType, initContext, tipe);
			}),
		viewFunctions);
	var qualifiedTypeAliases = A2(
		_elm_lang$core$Dict$map,
		F2(
			function (name, tipe) {
				return A2(_user$project$ToQualified$qualifyType, initContext, tipe);
		...
		localTypeAliases);
	var qualifiedUnionTypes = A2(
		_elm_lang$core$Dict$map,
		F2(
			function (name, unionR) {
				return A2(_user$project$ToQualified$qualifyUnionR, initContext, unionR);
			}),
		localUnionTypes);
	return {dottedModulePath: moduleInfo.dottedModulePath, viewFunctions: qualifiedViewFunctions, typeAliases: qualifiedTypeAliases, unionTypes: qualifiedUnionTypes};
};
var _user$project$ToQualified$emptyQualifiedModuleInfo = {dottedModulePath: 'EMPTY', viewFunctions: _elm_lang$core$Dict$empty, typeAliases: _elm_lang$core$Dict$empty, unionTypes: _elm_lang$core$Dict$empty};
var _user$project$ToQualified$qualifyAllTypes = function (_p32) {
	var _p33 = _p32;
	return {
		subjectModuleInfo: _user$project$ToQualified$toQualifiedModuleInfo(_p33.subjectModuleInfo),
		allModulesInfo: A2(
			_elm_lang$core$Dict$map,
			F2(
				function (dottedModulePath, moduleInfo) {
					return A2(
						_elm_lang$core$List$member,
						dottedModulePath,
						{
						...
						}) ? _user$project$ToQualified$emptyQualifiedModuleInfo : _user$project$ToQualified$toQualifiedModuleInfo(moduleInfo);
				}),
			_p33.allModulesInfo)
	};
};
...
var _user$project$DataGeneration$coreDifficultTypes = {
	...
	_1: {
		ctor: '::',
		_0: {dottedModulePath: 'Set', name: 'Set'},
		_1: {ctor: '[]'}
	}
};
...
var _user$project$DataGeneration$generateViewFunctions = function (unqualifiedAllTypes) {
	var _p35 = _user$project$ToQualified$qualifyAllTypes(unqualifiedAllTypes);
	var allTypes = _p35;
	var subjectModuleInfo = _p35.subjectModuleInfo;
	var allModulesInfo = _p35.allModulesInfo;
	return A2(
		_elm_lang$core$List$map,
		A2(_user$project$DataGeneration$generateViewFunction, allTypes, subjectModuleInfo.dottedModulePath),
		_elm_lang$core$Dict$toList(subjectModuleInfo.viewFunctions));
};

var _user$project$ModuleStatement$importStatementName = A2(
	_elm_tools$parser$Parser_ops['|='],
	A2(
		_elm_tools$parser$Parser_ops['|.'],
		A2(
			_elm_tools$parser$Parser_ops['|.'],
			_elm_tools$parser$Parser$succeed(_elm_lang$core$Basics$identity),
			_elm_tools$parser$Parser$symbol('module')),
		_user$project$ElmTypesParser$someWhitespace),
	_user$project$ElmTypesParser$qualifiedCapVar);
var _user$project$ModuleStatement$importStatement = A2(
	_elm_tools$parser$Parser_ops['|='],
	_elm_tools$parser$Parser$succeed(_elm_lang$core$Basics$identity),
	_user$project$ModuleStatement$importStatementName);
var _user$project$ModuleStatement$parseModuleStatement = function (string) {
	return A2(_elm_tools$parser$Parser$run, _user$project$ModuleStatement$importStatement, string);
};

var _user$project$FirstPass$replaceNewLinesWithSpaces = function (s) {
	return A3(_elm_community$string_extra$String_Extra$replace, '\n', ' ', s);
};
var _user$project$FirstPass$parseBlock = function (rawBlock) {
	var _p0 = rawBlock;
	switch (_p0.ctor) {
		case 'EmptyLines':
			return _elm_lang$core$Result$Ok(_user$project$Types$IgnoreBlock);
		...
		case 'TypeAliasDefinitionBlock':
			return A2(
				_elm_lang$core$Result$map,
				_user$project$Types$TypeAliasDefinition,
				_user$project$ElmTypesParser$parseTypeAlias(_p0._0));
		case 'TypeDefinition':
			return A2(
				_elm_lang$core$Result$map,
				_user$project$Types$Union,
				_user$project$ElmTypesParser$parseUnion(_p0._0));
		case 'TypeAnnotationBlock':
			return A2(
				_elm_lang$core$Result$map,
				_user$project$Types$TypeAnnotation,
				_user$project$ElmTypesParser$parseTypeAnnotation(_p0._0));
		case 'ModuleStatementBlock':
			return A2(
				_elm_lang$core$Result$map,
				_user$project$Types$Module,
				_user$project$ModuleStatement$parseModuleStatement(_p0._0));
		case 'FunctionDefinitionBlock':
			return _elm_lang$core$Result$Ok(_user$project$Types$IgnoreBlock);
		default:
			return _elm_lang$core$Result$Ok(_user$project$Types$IgnoreBlock);
	}
};
var _user$project$FirstPass$splitIntoBlocks = function (lines) {
	var _p1 = lines;
	if (_p1.ctor === '[]') {
		return {ctor: '[]'};
	} else {
...
var _user$project$FirstPass$removeOneLineComment = function (line) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		'',
		_elm_lang$core$List$head(
...
var _user$project$FirstPass$removeOneLineComments = function (lines) {
	return A2(_elm_lang$core$List$map, _user$project$FirstPass$removeOneLineComment, lines);
};
var _user$project$FirstPass$List = function (a) {
	return {ctor: 'List', _0: a};
};
var _user$project$FirstPass$UnknownBlock = function (a) {
	return {ctor: 'UnknownBlock', _0: a};
};
var _user$project$FirstPass$FunctionDefinitionBlock = function (a) {
	return {ctor: 'FunctionDefinitionBlock', _0: a};
};
var _user$project$FirstPass$TypeAnnotationBlock = function (a) {
	return {ctor: 'TypeAnnotationBlock', _0: a};
};
var _user$project$FirstPass$TypeDefinition = function (a) {
	return {ctor: 'TypeDefinition', _0: a};
};
var _user$project$FirstPass$TypeAliasDefinitionBlock = function (a) {
	return {ctor: 'TypeAliasDefinitionBlock', _0: a};
};
var _user$project$FirstPass$ModuleStatementBlock = function (a) {
	return {ctor: 'ModuleStatementBlock', _0: a};
};
var _user$project$FirstPass$ImportStatementBlock = function (a) {
	return {ctor: 'ImportStatementBlock', _0: a};
};
var _user$project$FirstPass$EmptyLines = function (a) {
	return {ctor: 'EmptyLines', _0: a};
};
var _user$project$FirstPass$classifyBlock = function (s) {
	return A2(_elm_lang$core$String$startsWith, 'module', s) ? _user$project$FirstPass$ModuleStatementBlock(s) : (A2(_elm_lang$core$String$startsWith, 'import', s) ? _user$project$FirstPass$ImportStatementBlock(
		_user$project$FirstPass$replaceNewLinesWithSpaces(s)) : (A2(_elm_lang$core$String$startsWith, 'type alias', s) ? _user$project$FirstPass$TypeAliasDefinitionBlock(s) : (A2(_elm_lang$core$String$startsWith, 'type', s) ? _user$project$FirstPass$TypeDefinition(s) : (A2(_elm_lang$core$String$contains, '=', s) ? _user$project$FirstPass$FunctionDefinitionBlock(s) : (A2(_elm_lang$core$String$contains, ':', s) ? _user$project$FirstPass$TypeAnnotationBlock(s) : _user$project$FirstPass$EmptyLines(s))))));
};
var _user$project$FirstPass$classifyBlocks = function (strings) {
	return A2(_elm_lang$core$List$map, _user$project$FirstPass$classifyBlock, strings);
};
var _user$project$FirstPass$parseModule = function (source) {
	return A2(
		_elm_lang$core$List$filterMap,
		_elm_lang$core$Basics$identity,
		A2(
			...
			A2(
				...
				_user$project$FirstPass$classifyBlocks(
					_user$project$FirstPass$splitIntoBlocks(
						_user$project$FirstPass$removeOneLineComments(
							_elm_lang$core$String$lines(source)))))));
};

var _user$project$DependentModules$getModuleInfo = function (_p0) {
	var _p1 = _p0;
	var blocks = _user$project$FirstPass$parseModule(_p1.sourceCode);
	...
	var externalNames = A2(
		_user$project$ModuleInfo$getExternalNames,
		A2(_user$project$ModuleInfo$LocalTypeDefinitions, localUnionTypes, localTypeAliases),
		_p1.relevantNames);
	var imports = A2(
		_elm_lang$core$Basics_ops['++'],
		_user$project$ImportStatement$elmImplicitImports,
		_user$project$ModuleInfo$filterByImports(blocks));
	var reversedImports = _elm_lang$core$List$reverse(imports);
	return {
		...
		dottedModulePath: _user$project$ModuleInfo$getDottedModulePath(blocks)
	};
};

var _user$project$DeterminePackageLocations$exactDependencyToPackagePath = function (_p0) {
	var _p1 = _p0;
	var _p4 = _p1._0;
...
var _user$project$DeterminePackageLocations$getPackagePaths = function (exactDependenciesContents) {
	return A2(
		...
		A2(
			...
			function (_p5) {
				return A2(
					_elm_lang$core$List$map,
					_user$project$DeterminePackageLocations$exactDependencyToPackagePath,
...
var _user$project$ReadSourceFiles$isInFlight = function (dirAttempt) {
	var _p0 = dirAttempt;
	if (_p0.ctor === 'InFlight') {
		return true;
	} else {
		return false;
	}
};
var _user$project$ReadSourceFiles$numCmdsInFlight = function (model) {
	return _elm_lang$core$List$length(
		A2(
			_elm_lang$core$List$filter,
			_user$project$ReadSourceFiles$isInFlight,
			_elm_lang$core$Dict$values(model.dirAttempts)));
};
		...
		A2(
			...
			A2(
				...
				function (_p1) {
					var _p2 = _p1;
					var _p3 = _p2._1;
					if (_p3.ctor === 'DirNotAttemptedYet') {
						return _elm_lang$core$Maybe$Just(_p2._0);
					} else {
						return _elm_lang$core$Maybe$Nothing;
					}
				},
				_elm_lang$core$Dict$toList(dirAttempts))));
};
var _user$project$ReadSourceFiles$atLeastOneSuccess = function (dirAttempts) {
	return _elm_lang$core$List$head(
		A2(
			_elm_lang$core$List$filterMap,
			_elm_lang$core$Basics$identity,
...
var _user$project$ReadSourceFiles$isFinished = function (model) {
	return _elm_community$maybe_extra$Maybe_Extra$isJust(model.maybeSourceCode);
};
var _user$project$ReadSourceFiles$hasFailed = function (model) {
	return ((!_user$project$ReadSourceFiles$isFinished(model)) && _elm_community$maybe_extra$Maybe_Extra$isNothing(
		_user$project$ReadSourceFiles$haveNotExhaustedAllOptions(model.dirAttempts))) ? _elm_lang$core$Maybe$Just(model) : _elm_lang$core$Maybe$Nothing;
};
var _user$project$ReadSourceFiles$getGoal = function (model) {
	return _user$project$ReadSourceFiles$isFinished(model) ? _elm_lang$core$Result$Ok(
		A2(_elm_lang$core$Maybe$withDefault, '', model.maybeSourceCode)) : _elm_lang$core$Result$Err(model);
};
			...
			return A2(
				...
				function (portScope) {
					return _elm_lang$core$Json_Decode$succeed(
						{maybeContents: maybeContents, portScope: portScope});
				},
				A2(
...
var _user$project$ReadSourceFiles$Model = F3(
	function (a, b, c) {
		return {moduleName: a, maybeSourceCode: b, dirAttempts: c};
	});
...
var _user$project$ReadSourceFiles$ReadElmModuleResultR = F2(
	function (a, b) {
		return {maybeContents: a, portScope: b};
	});
...
var _user$project$ReadSourceFiles$updateDirAttempt = F2(
	function (maybeSourceCode, maybeDirAttempt) {
		return A2(
			_elm_lang$core$Maybe$map,
			function (_p7) {
				var _p8 = maybeSourceCode;
				if (_p8.ctor === 'Just') {
					return _user$project$ReadSourceFiles$DirSuccess;
				} else {
...
var _user$project$ReadSourceFiles$getNextCmdsForDirAttempts = F2(
	function (moduleName, originalDirAttempts) {
		return function (_p9) {
			...
			return {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Dict$fromList(_p10.dirAttempts),
				_1: _p10.cmds
			};
		}(
			A3(
				...
				F2(
					function (_p12, _p11) {
						...
						var _p15 = function () {
							...
							if (_p16.ctor === '[]') {
								var _p17 = _p13._1;
								if (_p17.ctor === 'DirNotAttemptedYet') {
									return {
										ctor: '_Tuple2',
										_0: {ctor: '_Tuple2', _0: _p18, _1: _user$project$ReadSourceFiles$InFlight},
										_1: {
											ctor: '::',
											_0: _user$project$ReadSourceFiles$readElmModule(
												{
													path: path,
													portScope: {path: path, dir: _p18, moduleName: moduleName}
												}),
											_1: {ctor: '[]'}
										}
									};
								...
								return {ctor: '_Tuple2', _0: _p19, _1: _p16};
							}
						}();
						var newDirAttempt = _p15._0;
						var newCmds = _p15._1;
						return {
							dirAttempts: {ctor: '::', _0: newDirAttempt, _1: _p14.dirAttempts},
							cmds: newCmds
						};
					}),
				{
...
var _user$project$ReadSourceFiles$getNextCmds = function (_p20) {
	var _p21 = _p20;
	var _p26 = _p21.model;
	var _p22 = A2(
		_elm_lang$core$Debug$log,
		'numCmdsInFlight ',
		_user$project$ReadSourceFiles$numCmdsInFlight(_p26));
	var _p23 = _p26;
	var moduleName = _p23.moduleName;
	var maybeSourceCode = _p23.maybeSourceCode;
	var dirAttempts = _p23.dirAttempts;
	if (_p21.maxCmdsReached || (_elm_lang$core$Native_Utils.cmp(
		_user$project$ReadSourceFiles$numCmdsInFlight(_p26),
		1) > -1)) {
		return {
			ctor: '_Tuple2',
		...
		if (_p24.ctor === 'Just') {
			...
			var _p25 = A2(_user$project$ReadSourceFiles$getNextCmdsForDirAttempts, moduleName, dirAttempts);
			var newDirAttempts = _p25._0;
			var cmds = _p25._1;
			return {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Native_Utils.update(
					_p26,
					{dirAttempts: newDirAttempts}),
				_1: cmds
			};
		}
	}
};
var _user$project$ReadSourceFiles$kickBackIntoAction = function (model) {
	return _user$project$ReadSourceFiles$getNextCmds(
		{model: model, maxCmdsReached: false});
};
var _user$project$ReadSourceFiles$update = F3(
	function (msg, maxCmdsReached, model) {
		var _p27 = msg;
		var _p29 = _p27._0.maybeContents;
		var model2 = _elm_lang$core$Native_Utils.update(
			model,
			{
				dirAttempts: A3(
					_elm_lang$core$Dict$update,
					_p27._0.portScope.dir,
					_user$project$ReadSourceFiles$updateDirAttempt(_p29),
					model.dirAttempts),
				maybeSourceCode: _p29
			});
		var _p28 = _user$project$ReadSourceFiles$getNextCmds(
			{model: model2, maxCmdsReached: maxCmdsReached});
		var model3 = _p28._0;
		var cmds = _p28._1;
...
var _user$project$ReadSourceFiles$init = function (_p30) {
	var _p31 = _p30;
	var model = {
		moduleName: _p31.moduleName,
		dirAttempts: _elm_lang$core$Dict$fromList(
			A2(
				...
				_p31.sourceDirectories)),
		maybeSourceCode: _elm_lang$core$Maybe$Nothing
	};
	return _user$project$ReadSourceFiles$getNextCmds(
		{model: model, maxCmdsReached: false});
};
...
var _user$project$ReadSourceFiles$subscription = A2(
	...
	function (result) {
		var _p32 = result;
		return {ctor: '_Tuple2', _0: _p32._0.portScope.moduleName, _1: result};
	},
	...
	var viewFunctionNames = A2(
		...
		_user$project$Helpers$removeDuplicates(
			A2(
				...
				_elm_lang$core$Dict$values(_p4.viewFunctions))));
	return A2(
		_user$project$ModuleInfo$getExternalNames,
		A2(_user$project$ModuleInfo$LocalTypeDefinitions, _p4.localUnionTypes, _p4.localTypeAliases),
		viewFunctionNames);
};
...
var _user$project$Main$getNumCmdsInFlight = function (model) {
	return _elm_lang$core$List$sum(
		A2(
			_elm_lang$core$List$map,
			function (eitherModuleInfo) {
				var _p0 = eitherModuleInfo;
				if (_p0.ctor === 'NotLoaded') {
					return _user$project$ReadSourceFiles$numCmdsInFlight(_p0._0);
				} else {
					return 0;
				}
			},
			A2(
				_elm_lang$core$List$map,
				function (_) {
					return _.eitherModuleInfo;
				},
				_elm_lang$core$Dict$values(model.allModulesInfo))));
};
var _user$project$Main$simplifyAllModulesInfo = F2(
	function (allModulesInfo, subjectModuleInfo) {
		return A3(
			_elm_lang$core$Dict$insert,
			subjectModuleInfo.dottedModulePath,
			subjectModuleInfo,
			_elm_lang$core$Dict$fromList(
				A2(
					_elm_lang$core$List$filterMap,
					function (_p1) {
						var _p2 = _p1;
						var _p3 = _p2._1.eitherModuleInfo;
						if (_p3.ctor === 'Loaded') {
							return _elm_lang$core$Maybe$Just(
					...
					_elm_lang$core$Dict$toList(allModulesInfo))));
	});
var _user$project$Main$maxCmdsAtOnce = 3;
var _user$project$Main$classifyLoads = function (model) {
	return A3(
		_elm_lang$core$List$foldl,
		F2(
			function (_p5, _p4) {
				...
				var _p7 = _p4;
				var _p12 = _p7.loaded;
				var _p11 = _p7.inFlight;
				var _p10 = _p7.failed;
				var _p8 = _p6._1.eitherModuleInfo;
				if (_p8.ctor === 'Loaded') {
					return {
						inFlight: _p11,
						loaded: A2(
					...
					var _p9 = _user$project$ReadSourceFiles$hasFailed(_p8._0);
					if (_p9.ctor === 'Just') {
						return {
							inFlight: _p11,
							loaded: _p12,
		...
		_elm_lang$core$Dict$toList(model.allModulesInfo));
};
var _user$project$Main$getUnfinishedLoads = function (model) {
	return A2(
		_elm_lang$core$List$filterMap,
		_elm_lang$core$Basics$identity,
		A2(
			...
			function (_p14) {
				var _p15 = _p14;
				var _p16 = _p15._1.eitherModuleInfo;
				if (_p16.ctor === 'Loaded') {
					return _elm_lang$core$Maybe$Nothing;
				} else {
					var _p18 = _p16._0;
					var _p17 = _user$project$ReadSourceFiles$hasFailed(_p18);
					if (_p17.ctor === 'Just') {
						return _elm_lang$core$Maybe$Nothing;
					} else {
...
var _user$project$Main$getFailedLoads = function (model) {
	return A2(
		_elm_lang$core$List$filterMap,
		_elm_lang$core$Basics$identity,
		A2(
			...
			function (_p19) {
				var _p20 = _p19;
				var _p21 = _p20._1.eitherModuleInfo;
				if (_p21.ctor === 'Loaded') {
					return _elm_lang$core$Maybe$Nothing;
				} else {
					return _user$project$ReadSourceFiles$hasFailed(_p21._0);
				}
			},
			_elm_lang$core$Dict$toList(model.allModulesInfo)));
};
var _user$project$Main$getLoadedModuleInfos = function (model) {
	return _elm_lang$core$Dict$fromList(
		A2(
			_elm_lang$core$List$filterMap,
			_elm_lang$core$Basics$identity,
			A2(
				...
				function (_p22) {
					var _p23 = _p22;
					var _p24 = _p23._1.eitherModuleInfo;
					if (_p24.ctor === 'Loaded') {
						return _elm_lang$core$Maybe$Just(
							{ctor: '_Tuple2', _0: _p23._0, _1: _p24._0});
					} else {
						return _elm_lang$core$Maybe$Nothing;
					}
				},
...
var _user$project$Main$isFinished = function (model) {
	return _user$project$Helpers$allTrue(
		A2(
			_elm_lang$core$List$map,
			function (_p25) {
				return function (eitherModuleInfo) {
					var _p26 = eitherModuleInfo;
					if (_p26.ctor === 'Loaded') {
						return true;
					} else {
						return false;
...
var _user$project$Main$readElmPackageInfoContents = _elm_lang$core$Native_Platform.outgoingPort(
	'readElmPackageInfoContents',
	function (v) {
...
var _user$project$Main$init = function (_p27) {
	var _p28 = _p27;
	var _p30 = _p28.subjectSourceCode;
	var packageInfoResult = A2(_elm_lang$core$Json_Decode$decodeString, _user$project$PackageInfo$decoder, _p28.elmPackageContents);
	var _p29 = packageInfoResult;
	if (_p29.ctor === 'Ok') {
		var subjectModuleInfo = _user$project$SubjectModuleInfo$getModuleInfo(_p30);
		var packageDirs = _user$project$DeterminePackageLocations$getPackagePaths(_p28.exactDependenciesContents);
		var sourceDirectories = A2(_elm_lang$core$Basics_ops['++'], _p29._0.sourceDirectories, packageDirs);
		var elmPackageJsonPaths = A2(
			_elm_lang$core$List$map,
			function (packageDir) {
				return _ucode$elm_path$Path_Posix$joinPath(
					{
		...
		return A2(
			...
			{packageSourceDirectoriesFound: false, subjectSourceCode: _p30, sourceDirectories: sourceDirectories, subjectModuleInfo: subjectModuleInfo, allModulesInfo: _elm_lang$core$Dict$empty},
			{
				ctor: '::',
				_0: _user$project$Main$readElmPackageInfoContents(elmPackageJsonPaths),
				_1: {ctor: '[]'}
			});
	} else {
...
var _user$project$Main$readElmPackageInfoContentsResult = _elm_lang$core$Native_Platform.incomingPort(
	'readElmPackageInfoContentsResult',
...
var _user$project$Main$writeOutput = _elm_lang$core$Native_Platform.outgoingPort(
	'writeOutput',
	function (v) {
		return v;
	});
...
var _user$project$Main$Model = F5(
	function (a, b, c, d, e) {
		return {packageSourceDirectoriesFound: a, sourceDirectories: b, subjectSourceCode: c, subjectModuleInfo: d, allModulesInfo: e};
	});
var _user$project$Main$NotLoaded = function (a) {
	return {ctor: 'NotLoaded', _0: a};
};
var _user$project$Main$Loaded = function (a) {
	return {ctor: 'Loaded', _0: a};
};
var _user$project$Main$updateReadSourceFilesModel = F2(
	function (model, rsfModel) {
				...
				return {
					newAllModulesInfo: A3(
						...
						moduleName,
						{
							...
							eitherModuleInfo: _user$project$Main$Loaded(moduleInfo)
						},
						allModulesInfo),
...
var _user$project$Main$ReadElmPackageInfoContentsResult = function (a) {
	return {ctor: 'ReadElmPackageInfoContentsResult', _0: a};
};
var _user$project$Main$ReadSourceFilesMsg = F2(
	function (a, b) {
		return {ctor: 'ReadSourceFilesMsg', _0: a, _1: b};
	});
	...
	return _elm_lang$core$Platform_Sub$batch(
		A2(
			...
			A2(
				...
				{
					ctor: '::',
					_0: _user$project$Main$readElmPackageInfoContentsResult(_user$project$Main$ReadElmPackageInfoContentsResult),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
...
var _user$project$Main$Doing = {ctor: 'Doing'};
...
var _user$project$Main$handleReadSourceFilesMsg = function (_p56) {
	...
	var writeOutputFileCmd = function () {
		...
		if (_p62 === true) {
			...
			var output = A2(
				_elm_lang$core$String$join,
				'\n\n\n\n',
				_user$project$DataGeneration$generateViewFunctions(
	...
	var _p69 = function () {
		...
		switch (_p70.ctor) {
			...
			case 'Doing':
				if (_elm_lang$core$List$isEmpty(readSourceFilesCmds)) {
					var rsfModel = _user$project$Helpers$unsafeListHead(
						_user$project$Main$getUnfinishedLoads(newModel));
					return A2(
						_elm_lang$core$Tuple$mapSecond,
						_elm_lang$core$List$map(
							_elm_lang$core$Platform_Cmd$map(
								_user$project$Main$ReadSourceFilesMsg(rsfModel.moduleName))),
						A2(
							_elm_lang$core$Tuple$mapFirst,
	...
	return {
		...
		_1: _elm_lang$core$Platform_Cmd$batch(
			{
				ctor: '::',
				_0: _elm_lang$core$Platform_Cmd$batch(readSourceFilesCmds2),
				_1: {
					ctor: '::',
					_0: writeOutputFileCmd,
					_1: {ctor: '[]'}
				}
			})
	};
